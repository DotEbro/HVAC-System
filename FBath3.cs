...
{
    public partial class FBath3 : Form
    {
        ...
        private void EWallHbtn_Click(object sender, EventArgs e)
        {
            ...
            else if (ExposedWall.Text == "North")
            {
                HeatOFEastEX_Wall = (0.4789 * double.Parse(EWallLen.Text) * double.Parse(EWallHeight.Text) * 14) / 1000;
                EWallH_N.Text = HeatOFEastEX_Wall.ToString();
            }
            else if (ExposedWall.Text == "South")
            {
        ...
        private void DoorHeatbtn_Click(object sender, EventArgs e)
        {
            if (Door.Text == "East")
            {
                HeatOFDoor = (0.18 * double.Parse(DoorLen.Text) * double.Parse(DoorWidth.Text) * 22) / 1000;
