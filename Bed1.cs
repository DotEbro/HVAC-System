...
{
    public partial class Bed1 : Form
    {
        ...
        private void WinHbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                HeatOFNorthWindow = (double.Parse(WinLen.Text) * double.Parse(WinWid.Text) * 120) / 1000;
                WinH_N.Text = HeatOFNorthWindow.ToString();
            }
            else if (Window.Text == "West")
            {
                HeatOFWestWindow = (double.Parse(WinLen.Text) * double.Parse(WinWid.Text) * 268) / 1000;
        ...
        private void EWallHbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                HeatOFEastEX_Wall = (0.4789 * double.Parse(EWallLen.Text) * double.Parse(EWallHeight.Text) * 16) / 1000;
        ...
        private void DoorHeatbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                HeatOFDoor = (0.18 * double.Parse(DoorLen.Text) * double.Parse(DoorWidth.Text) * 10) / 1000;
